...
hero:
  name: "agent-called-what"
  text: "What AI agents actually call"
  tagline: "Behavior-based rankings of MCP servers, agent skills & libraries — not star counters."
  actions:
    - theme: brand
      text: View MCP Ranking
      link: /mcp
    - theme: alt
      text: View Skills Ranking
      link: /skills
    - theme: alt
      text: How it works
      link: /methodology
